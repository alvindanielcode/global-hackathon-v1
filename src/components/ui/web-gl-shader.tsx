  ...
  useEffect(() => {
    ...
    const fragmentShader = `
      ...
      void main() {
        ...
        // Reduced intensity for less brightness
        ...
        // White and purple tones - more white (high r,g,b), more purple (high r,b)
        r = r * 1.2;  // Increase red for white/purple
        g = g * 0.6;  // Reduce green for purple tone
        b = b * 1.5;  // Increase blue for purple
        
        // Add subtle fade to reduce overall brightness
